...
SpeedSection:NewTextBox("Vitesse", "Entre une valeur", function(value)
    walkspeed = tonumber(value)
end)
SpeedSection:NewButton("Appliquer", "Change la vitesse", function()
    if walkspeed then
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = walkspeed
    end
end)
SpeedSection:NewButton("Réinitialiser", "Vitesse à 16", function()
